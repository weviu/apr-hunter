      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            <div className={`${getProtocolColorClass(position.detectionType)} w-2 h-2 rounded-full`} />
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              ...
              <p className="text-white font-medium">{position.apr.toFixed(2)}%</p>
            </div>
            <div>
              <p className="text-gray-400">Chain</p>
              <p className="text-white font-medium">{position.chainName}</p>
            </div>
            <div>
              <p className="text-gray-400">Platform</p>
              <p className="text-white font-medium text-xs">{position.platform}</p>
            </div>
          </div>
        ...
        {onImport && (
          <button
            ...
            disabled={isLoading}
            className="px-3 py-2 bg-blue-800 hover:bg-blue-900 disabled:bg-gray-600 disabled:cursor-not-allowed text-white text-sm rounded font-medium transition whitespace-nowrap"
          >
